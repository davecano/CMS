...
namespace JumboTCMS.API.Discuz.Toolkit
{
    public class Util
    {
        ...
        ///E:/swf/ 获取API提交的参数
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="request">request对象</param>
        ///E:/swf/ <returns>参数数组</returns>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 根据参数和密码生成签名字符串
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="parameters">API参数</param>
        ///E:/swf/ <param name="secret">密码</param>
        ///E:/swf/ <returns>签名字符串</returns>
