...
namespace JumboTCMS.API.Alipay
{
    ///E:/swf/ <summary>
    ///E:/swf/ 类名：Submit
    ///E:/swf/ 功能：支付宝各接口请求提交类
    ///E:/swf/ 详细：构造支付宝各接口表单HTML文本，获取远程HTTP数据
    ///E:/swf/ 版本：3.2
    ...
    public class Submit
    {
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 生成要请求给支付宝的参数数组
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sParaTemp">请求前的参数数组</param>
        ///E:/swf/ <returns>要请求的参数数组</returns>
        ...
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sParaTemp">请求前的参数数组</param>
        ///E:/swf/ <returns>要请求的参数数组字符串</returns>
        ...
        ///E:/swf/ 构造提交表单HTML数据
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sParaTemp">请求参数数组</param>
        ///E:/swf/ <param name="gateway">网关地址</param>
        ///E:/swf/ <param name="strMethod">提交方式。两个值可选：post、get</param>
        ///E:/swf/ <param name="strButtonValue">确认按钮显示文字</param>
        ///E:/swf/ <returns>提交表单HTML文本</returns>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 构造模拟远程HTTP的POST请求，获取支付宝的返回XML处理结果
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sParaTemp">请求参数数组</param>
        ///E:/swf/ <param name="gateway">网关地址</param>
        ///E:/swf/ <returns>支付宝返回XML处理结果</returns>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 构造模拟远程HTTP的GET请求，获取支付宝的返回XML处理结果
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sParaTemp">请求参数数组</param>
        ///E:/swf/ <param name="gateway">网关地址</param>
        ///E:/swf/ <returns>支付宝返回XML处理结果</returns>
