...
namespace JumboTCMS.API.Alipay
{
    ...
    ///E:/swf/ 类名：Core
    ///E:/swf/ 功能：支付宝接口公用函数类
    ///E:/swf/ 详细：该类是请求、通知返回两个文件所调用的公用函数核心处理文件，不需要修改
    ///E:/swf/ 版本：3.2
    ...
    public class Core
    {
        ...
        ///E:/swf/ 生成签名结果
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sArray">要签名的数组</param>
        ///E:/swf/ <param name="key">安全校验码</param>
        ///E:/swf/ <param name="sign_type">签名类型</param>
        ///E:/swf/ <param name="_input_charset">编码格式</param>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 除去数组中的空值和签名参数并以字母a到z的顺序排序
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="dicArrayPre">过滤前的参数组</param>
        ///E:/swf/ <returns>过滤后的参数组</returns>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sArray">需要拼接的数组</param>
        ///E:/swf/ <returns>拼接完成以后的字符串</returns>
        ...
        ///E:/swf/ 签名字符串
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="prestr">需要签名的字符串</param>
        ///E:/swf/ <param name="sign_type">签名类型</param>
        ///E:/swf/ <param name="_input_charset">编码格式</param>
        ///E:/swf/ <returns>签名结果</returns>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 写日志，方便测试（看网站需求，也可以改成把记录存入数据库）
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sWord">要写入日志里的文本内容</param>
