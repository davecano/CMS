...
namespace JumboTCMS.API.Alipay
{
    ...
    ///E:/swf/ 
    ///E:/swf/ 要传递的参数要么不允许为空，要么就不要出现在数组与隐藏控件或URL链接里。
    ///E:/swf/ </summary>
    public class Service
    {
        ...
        ///E:/swf/ 构造即时到帐接口
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sParaTemp">请求参数集合</param>
        ///E:/swf/ <returns>表单提交HTML信息</returns>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 用于防钓鱼，调用接口query_timestamp来获取时间戳的处理函数
        ///E:/swf/ 注意：远程解析XML出错，与IIS服务器配置有关
        ///E:/swf/ </summary>
        ///E:/swf/ <returns>时间戳字符串</returns>
        ...
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="sParaTemp">请求参数集合</param>
        ///E:/swf/ <returns>表单提交HTML文本或者支付宝返回XML处理结果</returns>
