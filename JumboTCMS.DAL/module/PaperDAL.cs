...
{
    public class Module_paperDAL : Module_articleDAL
    {
        public Module_paperDAL()
        {
        }
        public override void CreateContent(string _ChannelId, string _ContentId, int _CurrentPage)
        {
            ...
            {
                _doh.Reset();
                _doh.SqlCmd = "SELECT [FirstPage] FROM [jcms_module_paper] WHERE [ChannelId]=" + _ChannelId + " and [Id]=" + _ContentId;
                ...
                {
                    _doh.Reset();
                    _doh.SqlCmd = "UPDATE [jcms_module_paper] SET [FirstPage]='" + Go2View(1, true, _ChannelId, _ContentId, false) + "' WHERE [ChannelId]=" + _ChannelId + " and [IsPass]=1 and [Id]=" + _ContentId;
        ...
        public override string GetContent(string _ChannelId, string _ContentId, int _CurrentPage)
        {
            ...
            using (DbOperHandler _doh = new Common().Doh())
            {
                ...
                _doh.Reset();
                _doh.SqlCmd = "SELECT [ClassId] FROM [jcms_module_paper] WHERE [ChannelId]=" + _ChannelId + " and [Id]=" + _ContentId;
                ...
                _doh.Reset();
                _doh.SqlCmd = "SELECT * FROM [jcms_module_paper] WHERE [ChannelId]=" + _ChannelId + " and [Id]=" + _ContentId;
                DataTable dtContent = _doh.GetDataTable();
                System.Collections.ArrayList ContentList = new System.Collections.ArrayList();
                p__GetChannel_Paper(te, dtContent, ref PageStr, ref ContentList, 0);
                ...
                p__replaceSinglePaper(dtContent, ref PageStr, ref ContentList);
                dtContent.Clear();
                dtContent.Dispose();
                return ContentList[0].ToString();
            }
        }
        private void p__GetChannel_Paper(TemplateEngineDAL te, DataTable dt, ref string PageStr, ref System.Collections.ArrayList ContentList, int i)
        {
        ...
        private void p__replaceSinglePaper(DataTable dt, ref string PageStr, ref System.Collections.ArrayList ContentList)
        {
        }
    }
}
