...
namespace JumboTCMS.DAL
{
    ...
    public class Normal_ExtendsDAL : Common
    {
        ...
        ///E:/swf/ 是否正在运行
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="_extendname">插件名称</param>
        ///E:/swf/ <returns></returns>
        ...
        public void GetListJSON(int _thispage, int _pagesize, string _wherestr, ref string _jsonstr)
        {
            using (DbOperHandler _doh = new Common().Doh())
            {
                ...
                _doh.ConditionExpress = _wherestr;
                string sqlStr = "";
                int _totalcount = _doh.Count("jcms_normal_extends");
                sqlStr = JumboTCMS.Utils.SqlHelper.GetSql0("[Id],[Title],[Name],[Author],[Info],[Type],[pId],[BaseTable],[Locked],[Enabled]", "jcms_normal_extends", "pId", _pagesize, _thispage, "asc", _wherestr);
                _doh.Reset();
                _doh.SqlCmd = sqlStr;
        ...
        ///E:/swf/ 获得新插件列表JSON
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="_jsonstr"></param>
        ...
        ///E:/swf/ 安装插件
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="_name"></param>
        ///E:/swf/ <param name="_response">返回信息</param>
        ...
        public bool BatchOper(string _act, string _ids)
        {
            using (DbOperHandler _doh = new Common().Doh())
            {
                ...
                string TempStr = "";
                _doh.Reset();
                _doh.SqlCmd = JumboTCMS.Utils.SqlHelper.GetSql0("[Title],[Name],[Type],[Enabled]", "jcms_normal_extends", "pId", 100, 1, "desc", "");
                DataTable dt = _doh.GetDataTable();
        ...
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="_id"></param>
        ///E:/swf/ <param name="_err">返回错误信息</param>
        ///E:/swf/ <returns></returns>
