...
namespace JumboTCMS.Entity
{
    ...
    ///E:/swf/ 文库实体列表
    ///E:/swf/ </summary>
    public class Module_Papers
    {
        public Module_Papers()
        { }
        public List<Module_Paper> DT2List(DataTable _dt)
        {
            if (_dt == null) return null;
            return JumboTCMS.Utils.dtHelp.DT2List<Module_Paper>(_dt);
        }
    }
    ///E:/swf/ <summary>
    ///E:/swf/ 文库-------表映射实体
