...
namespace JumboTCMS.Utils
{
    public static class ImageHelper
    {
        ...
        ///E:/swf/ 生成缩略图
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="originalImagePath">源图路径（物理路径）</param>
        ///E:/swf/ <param name="thumbnailPath">缩略图路径（物理路径）</param>
        ///E:/swf/ <param name="width">缩略图宽度</param>
        ///E:/swf/ <param name="height">缩略图高度</param>
        ///E:/swf/ <param name="mode">生成缩略图的方式
        ///E:/swf/ <code>HW:指定高宽缩放（可能变形）</code>
        ///E:/swf/ <code>W:指定宽，高按比例  </code>
        ///E:/swf/ <code>H:指定高，宽按比例</code>
        ///E:/swf/ <code>CUT:指定高宽裁减（不变形） </code>
        ///E:/swf/ <code>FILL:填充</code>
        ///E:/swf/ <code>FULL:全图不变</code>
        ///E:/swf/ </param>    
        ...
        ///E:/swf/ 生成远程图片的缩略图
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="remoteImageUrl"></param>
        ///E:/swf/ <param name="thumbnailPath"></param>
        ///E:/swf/ <param name="width"></param>
        ///E:/swf/ <param name="height"></param>
        ///E:/swf/ <param name="mode"></param>
        ///E:/swf/ <returns></returns>
        ...
        ///E:/swf/ 生成缩略图
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="originalImage">源图</param>
        ///E:/swf/ <param name="thumbnailPath">缩略图路径（物理路径）</param>
        ///E:/swf/ <param name="photoWidth">最终缩略图宽度</param>
        ///E:/swf/ <param name="height">最终缩略图高度</param>
        ///E:/swf/ <param name="mode">生成缩略图的方式
        ///E:/swf/ <code>HW:指定高宽缩放（可能变形）</code>
        ///E:/swf/ <code>W:指定宽，高按比例  </code>
        ///E:/swf/ <code>H:指定高，宽按比例</code>
        ...
        ///E:/swf/ <param name="originalImagePath">源图路径（物理路径）</param>
        ///E:/swf/ <param name="thumbnailPath">缩略图路径（物理路径）</param>
        ///E:/swf/ <param name="toW">缩略图最终宽度</param>
        ///E:/swf/ <param name="toH">缩略图最终高度</param>
        ///E:/swf/ <param name="X">X坐标（zoom为1时）</param>
        ///E:/swf/ <param name="Y">Y坐标（zoom为1时）</param>
        ///E:/swf/ <param name="W">选择区域宽（zoom为1时）</param>
        ///E:/swf/ <param name="H">选择区域高（zoom为1时）</param>
        ...
        ///E:/swf/ 在图片上增加文字水印
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="Path">原服务器图片路径</param>
        ///E:/swf/ <param name="Path_sy">生成的带文字水印的图片路径</param>
        ///E:/swf/ <param name="addText">水印文字</param>
        ...
        ///E:/swf/ 加图片水印
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="filename">文件名</param>
        ///E:/swf/ <param name="watermarkFilename">水印文件名</param>
        ///E:/swf/ <param name="watermarkStatus">图片水印位置:0=不使用 1=左上 2=中上 3=右上 4=左中 ... 9=右下</param>
        ///E:/swf/ <param name="quality">是否是高质量图片 取值范围0--100</param> 
        ///E:/swf/ <param name="watermarkTransparency">图片水印透明度 取值范围1--10 (10为不透明)</param>
        ...
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="Path">原服务器图片路径</param>
        ///E:/swf/ <param name="Path_syp">生成的带图片水印的图片路径</param>
        ///E:/swf/ <param name="Path_sypf">水印图片路径</param>
