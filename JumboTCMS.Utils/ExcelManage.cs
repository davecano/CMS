...
namespace JumboTCMS.Utils
{
    ...
    public class ExcelManage
    {
        ...
        ///E:/swf/ 获取Excel数据表列表
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="ExcelFileName"></param>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 获取指定Excel文件数据表的数据列列表
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="ExcelFileName">Excel文件名</param>
        ///E:/swf/ <param name="TableName">数据表名</param>
        ///E:/swf/ <returns></returns>
        ...
        ///E:/swf/ 将数据导出至Excel
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="Table">DataTable对象</param>
        ///E:/swf/ <param name="ExcelFilePath">Excel文件路径</param>
        ///E:/swf/ <returns></returns>
        ...
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="Table">DataTable对象</param>
        ///E:/swf/ <param name="Columns">要导出的数据列集合</param>
        ///E:/swf/ <param name="ExcelFilePath">Excel文件路径</param>
        ///E:/swf/ <returns></returns>
        ...
        ///E:/swf/ <summary>
        ///E:/swf/ 导入Excel数据表至DataTable（第一行作为表头）
        ///E:/swf/ </summary>
        ///E:/swf/ <param name="ExcelFilePath">Excel文件路径</param>
        ///E:/swf/ <param name="TableName">数据表名，如果数据表名错误，默认为第一个数据表名</param>
        ///E:/swf/ <returns></returns>
