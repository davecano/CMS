<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templateinclude_edittemplate.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._templateinclude_edittemplate" %>
...
<form id="form1" runat="server" onsubmit="return CheckFormSubmit()">
	<table class="formtable mrg10T">
		<tr>
			...
			<br /><span style="color:Red">标签功能请查阅《模板和标签.doc》</span><br />
