<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adv_edit.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._adv_edit" %>
...
<form id="form1" runat="server" onsubmit="return CheckFormSubmit()">
	<table class="formtable mrg10T">
		...
		<tr>
			<th> 链接URL<span class="tip-t" tip="只对图片广告有效" /></th>
		...
		<tr>
			<th> 上传广告图 </th>
			<td><iframe id="frm_upload" src="other_upload.aspx?type=adv" width="100%" height="30" scrolling="no" frameborder="0"></iframe></td>
		</tr>
		<tr>
			<th>简介/内容<span class="tip-t" tip="1、如果是html代码，请将代码内容填入此处，此时，“链接URL”无效<br>2、如果是iframe网页，请将网页地址填入此处，此时，“链接URL”无效<br>3、是图片、动画时“广告图URL”才有效，此处留空即可" /></th>
