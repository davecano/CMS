<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="module_article_collfilters_edit1.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._article_CollFilters_edit1" %>
...
<form id="form1" runat="server" onsubmit="return jQuery.formValidator.PageIsValid('1')">
	<table class="formtable mrg10T">
		...
		<tr>
			<th> 开始前标记 </th>
			<td><asp:TextBox ID="txtFisString" runat="server" Height="97px" TextMode="MultiLine"
                    Width="97%" CssClass="ipt"></asp:TextBox>
			</td>
		</tr>
		<tr>
			<th> 结束后标记 </th>
			<td><asp:TextBox ID="txtFioString" runat="server" Height="97px" TextMode="MultiLine"
                    Width="97%" CssClass="ipt"></asp:TextBox>
			</td>
		</tr>
		<tr>
