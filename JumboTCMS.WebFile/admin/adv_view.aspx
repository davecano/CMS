<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adv_view.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._adv_view" %>
...
<table class="formtable mrg10T">
	...
	<div class="buttonok">
		<input id="btnReset" type="button" value="返回" class="btncancel" onclick="parent.JumboTCMS.Popup.hide();" />
	</div>
</form>
