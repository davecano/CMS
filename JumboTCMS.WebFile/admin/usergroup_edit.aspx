<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="usergroup_edit.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._usergroup_edit" %>
...
$(document).ready(function(){
	...
	$("#txtGroupName").formValidator({tipid:"tipGroupName",onshow:"请输入用户组名",onfocus:"建议输入4-6个汉字"}).InputValidator({min:6,max:12,onerror:"你输入的长度不正确,请确认"});
	$("#GroupSet3").formValidator({tipid:"tipGroupSet3",onshow:"起止小时，|隔开",onfocus:"格式例如：0|23"}).RegexValidator({regexp:"^[0-9]{1}\\|[0-9]{1,2}$",onerror:"格式有误"});
	$("#GroupSet5").formValidator({tipid:"tipGroupSet5",onshow:"0为不限制",onfocus:"0为不限制"}).RegexValidator({regexp:"^\\d{1,3}$",onerror:"请填写1000以内的数字"});
	$("#GroupSet6").formValidator({tipid:"tipGroupSet6",onshow:"0为不限制",onfocus:"0为不限制"}).RegexValidator({regexp:"^\\d{1,3}$",onerror:"请填写1000以内的数字"});
	$("#GroupSet11").formValidator({tipid:"tipGroupSet11",onshow:"0为不限制",onfocus:"0为不限制"}).RegexValidator({regexp:"^\\d{1,3}$",onerror:"请填写1000以内的数字"});
	$("#GroupSet14").formValidator({tipid:"tipGroupSet14",onshow:"0为不限制",onfocus:"0为不限制"}).RegexValidator({regexp:"^\\d{1,3}$",onerror:"请填写1000以内的数字"});
	$("#GroupSet17").formValidator({tipid:"tipGroupSet17",onshow:"0为不限制",onfocus:"0为不限制"}).RegexValidator({regexp:"^\\d{1,3}$",onerror:"请填写1000以内的数字"});
});
/*最后的表单验证*/
