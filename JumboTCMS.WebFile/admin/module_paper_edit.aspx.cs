...
{
    public partial class _module_paper_edit : JumboTCMS.UI.AdminCenter
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            doh.Reset();
            JumboTCMS.DBUtility.WebFormHandler wh = new JumboTCMS.DBUtility.WebFormHandler(doh, "jcms_module_paper", btnSave);
            ...
            wh.AddBind(txtPaperUrl, "PaperUrl", true);
        ...
        protected bool chkForm()
        {
            ...
            if (!Page.IsValid)
                return false;
            if (this.txtPaperUrl.Text.Length == 0)
            {
                lbPaperUrlMsg.Text = "请填写PDF文件地址!";
                return false;
            }
            return true;
        }
        protected void save_ok(object sender, EventArgs e)
        {
            ...
            string PdfFile = this.txtPaperUrl.Text;
            string SwfFile = ChannelUploadPath + JumboTCMS.Utils.MD5.Lower32(id) + ".swf";
            bool _SaveSWF = JumboTCMS.Utils.swftoolsHelper.PDF2SWF(PdfFile, SwfFile);
            doh.AddFieldItem("SwfFile", SwfFile);
            if (!_SaveSWF)
                doh.AddFieldItem("IsPass", 0);
            doh.Update("jcms_module_paper");
            ...
            if (_SaveSWF)
                ...
                FinalMessage("SWF生成失败", "close.htm", 0);
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //格式化地址
            this.txtPaperUrl.Text = this.txtPaperUrl.Text.Replace("\'", "").Replace("\"", "");
            //格式化标签
