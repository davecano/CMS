<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="module_document_edit.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._module_document_edit" %>
	...
	<table class="formtable mrg10T">
		...
		<tr>
			...
			<td colspan="3"><asp:TextBox ID="txtPageSize" runat="server" Visible="false" CssClass="ipt">1</asp:TextBox>
				<asp:TextBox ID="txtDocumentUrl" runat="server" Width="500px" CssClass="ipt"></asp:TextBox><a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('attachment_preview.aspx?ccid=<%=ChannelId %>&ElementID=txtDocumentUrl',600,420,true)"><img src="../statics/admin/images/preview.gif" align="absmiddle" style="border:0px;" /></a>
				<br />
