<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="module_paper_edit.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._module_paper_edit" %>
	...
	<table class="formtable mrg10T">
		...
		<tr>
			...
			<td colspan="3"><asp:TextBox ID="txtPageSize" runat="server" Visible="false" CssClass="ipt">1</asp:TextBox>
				<asp:TextBox ID="txtPaperUrl" runat="server" Width="500px" CssClass="ipt"></asp:TextBox>
				<br />
				<asp:Label ID="lbPaperUrlMsg" runat="server" ForeColor="Red"></asp:Label>
			</td>
		</tr>
		<tr>
			<th> 指定文件路径(第1页) </th>
