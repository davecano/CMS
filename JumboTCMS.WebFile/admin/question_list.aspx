<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="question_list.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._question_list" %>
...
function ajaxList(currentpage)
{
	...
	$.ajax({
		...
		url:		"question_ajax.aspx?oper=ajaxGetList",
...
function operater(act){
	...
	$.ajax({
		...
		dataType:	"json",
		data:		"ids="+ids,
		url:		"question_ajax.aspx?oper=ajaxBatchOper&act="+act+"&clienttime="+Math.random(),
...
<div class="topnav">
	...
	<ul id="topnavbar">
		...
		<li class="topmenu"><a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('question_config.aspx',500,260,true)" class="top_link"><span>参数设置</span></a></li>
	</ul>
	<script>
	topnavbarStuHover();
    </script>
