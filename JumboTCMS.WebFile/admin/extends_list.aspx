...
function operater(act){
	...
	$.ajax({
		...
		dataType:	"json",
		data:		"ids="+ids,
		url:		"extends_ajax.aspx?oper=ajaxBatchOper&act="+act+"&clienttime="+Math.random(),
...
function move(id,isUp){
	$.ajax({
		...
		dataType:	"json",
		data:		"id="+id+"&up="+isUp,
		url:		"extends_ajax.aspx?oper=move&clienttime="+Math.random(),
		error:		function(XmlHttpRequest,textStatus, errorThrown){alert(XmlHttpRequest.responseText); },
		success:	function(d){
			switch (d.result)
			{
...
function ajaxDel(id){
	$.ajax({
		...
		dataType:	"json",
		data:		"id="+id,
		url:		"extends_ajax.aspx?oper=ajaxDel&clienttime="+Math.random(),
		error:		function(XmlHttpRequest,textStatus, errorThrown){alert(XmlHttpRequest.responseText); },
		success:	function(d){
			switch (d.result)
			{
...
function ajaxInstall(extendname)
{
	$.ajax({
		...
		url:		"extends_ajax.aspx?oper=install&clienttime="+Math.random(),
		error:		function(XmlHttpRequest,textStatus, errorThrown) { alert(XmlHttpRequest.responseText);},
		success:	function(d){
			switch (d.result)
			{
...
<thead>
	<tr>
		...
		<th scope="col" style="width:110px;">插件类型</th>
...
<textarea class="template" id="tplNew" style="display:none">
<table class="cooltable">
<thead>
	<tr>
