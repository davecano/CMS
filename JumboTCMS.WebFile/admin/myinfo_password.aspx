<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="myinfo_password.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._myinfo_password" %>
...
function ajaxChangePass()
{
	$.ajax({
		type:		"post",
		dataType:	"json",
		data:		"oldpass="+encodeURIComponent(JumboTCMS.MD5($("#txtOldPass").val()))+"&newpass="+encodeURIComponent(JumboTCMS.MD5($("#txtNewPass1").val())),
		url:		"myinfo_ajax.aspx?oper=changepass&clienttime="+Math.random(),
