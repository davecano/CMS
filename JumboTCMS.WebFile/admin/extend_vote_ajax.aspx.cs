...
{
    public partial class _extend_vote_ajax : JumboTCMS.UI.AdminCenter
    {
        ...
        private void ajaxGetList()
        {
            ...
            totalCount = doh.Count("jcms_extends_vote");
            sqlStr = JumboTCMS.Utils.SqlHelper.GetSql0("*,(select title FROM [jcms_normal_channel] WHERE id=jcms_extends_vote.channelid) as ChannelName", "jcms_extends_vote", "Id", PSize, page, "desc", whereStr);
