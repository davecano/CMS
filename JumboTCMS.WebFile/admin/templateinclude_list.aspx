...
function ajaxDel(id){
	$.ajax({
		...
		dataType:	"json",
		data:		"id="+id,
		url:		"templateinclude_ajax.aspx?oper=ajaxDel&clienttime="+Math.random() + pid,
...
<tbody>
	...
	<tr onmouseover="this.style.backgroundColor='F3F7FF'" onmouseout="this.style.backgroundColor='FFFFFF'">
		...
		<td align="center">
			...
			<a href="javascript:void(0);" onclick="top.JumboTCMS.Popup.show('templateinclude_edittemplate.aspx?id={$T.record.id}{pid}',-1,-1,true)">在线编辑</a>
