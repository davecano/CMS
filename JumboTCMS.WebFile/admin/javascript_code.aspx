<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="javascript_code.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._javascriptcode" %>
...
<form id="form1" runat="server">
	...
	<div class="buttonok">
		...
		<input id="btnReset" type="button" value="关闭窗口" class="btncancel" onclick="parent.JumboTCMS.Popup.hide();" />
	</div>
</form>
