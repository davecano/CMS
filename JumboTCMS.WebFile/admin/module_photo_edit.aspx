<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="module_photo_edit.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._module_photo_edit" %>
...
<form id="form1" runat="server" onsubmit="return CheckFormSubmit()">
	<table class="formtable mrg10T">
		...
		<tr>
			<th> 图片上传 </th>
			<td><iframe id="frm_upload" src="attachment_default2.aspx?ccid=<%=ChannelId %>" width="100%"
