...
namespace JumboTCMS.WebFile.Admin
{
    public partial class _class_ajax : JumboTCMS.UI.AdminCenter
    {
        ...
        private void ajaxGetList()
        {
            ...
            doh.Reset();
            doh.SqlCmd = "SELECT [ID],[Title],[Code],[IsPaging],[PageSize],[IsOut],[SortRank],len(Code) as codelength,[ChannelId],[IsTop],[topicnum],(select title from [jcms_normal_theme] where id=[jcms_normal_class].ThemeId) as templatename,(select title from [jcms_normal_theme] where id=[jcms_normal_class].ContentTheme) as contenttempname FROM [jcms_normal_class] WHERE [ChannelId]=" + ChannelId + " ORDER BY code";
