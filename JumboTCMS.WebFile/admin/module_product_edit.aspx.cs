...
{
    public partial class _module_product_edit : JumboTCMS.UI.AdminCenter
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            doh.Reset();
            JumboTCMS.DBUtility.WebFormHandler wh = new JumboTCMS.DBUtility.WebFormHandler(doh, "jcms_module_product", btnSave);
        ...
        {
            this.txtPrice0.Text = JumboTCMS.Utils.Strings.ToMoney(this.txtPrice0.Text);
