<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templateinclude_edit.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._templateinclude_edit" %>
...
$(document).ready(function(){
	...
	$("#txtTitle").formValidator({tipid:"tipTitle",onshow:"请输入模块名称",onfocus:"请输入6-20个字符"}).InputValidator({min:6,max:20,onerror:"请输入6-20个字符"});
	$("#txtSort").formValidator({tipid:"tipSort",onshow:"数字越大，优先权越高",onfocus:"0为最低"}).RegexValidator({regexp:"^\\d{1,3}$",onerror:"请填写1000以内的数字"});
