...
{
    public partial class _tags_ajax : JumboTCMS.UI.AdminCenter
    {
        ...
        {
            Admin_Load(ChannelId + "-09", "json", true);
            ...
            totalCount = doh.Count("jcms_normal_tag");
            NameValueCollection orders = new NameValueCollection();
            orders.Add("ClickTimes", "desc");
            orders.Add("Id", "desc");
            string FieldList = "*";
