<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="module_document_list.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._module_document_list" %>
...
<thead>
	<tr>
		...
		<th scope="col" style="width:70px;">下载需博币</th>
...
<tbody>
	...
	<tr>
		...
		<td align="left">&nbsp;
			...
			{#else}
			<a href="../controls/document.aspx?ChannelId={$T.record.channelid}&id={$T.record.id}&preview=1" target="_blank" style="color:{$T.record.tcolor}">{$T.record.title}</a>
			{#/if}
		</td>
