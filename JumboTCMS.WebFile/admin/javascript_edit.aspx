<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="javascript_edit.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._javascriptedit" %>
...
$(document).ready(function(){
	...
	$("#txtTitle").formValidator({tipid:"tipTitle",onshow:"请输入名称",onfocus:"请输入名称"}).InputValidator({min:8,max:30,onerror:"请输入8-30个字符或4-15个汉字,请确认"});
});
/*最后的表单验证*/
