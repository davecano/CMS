...
$(document).ready(function(){
	...
	$("#txtAdminUploadType").formValidator({validatorGroup:"1",tipid:"tipAdminUploadType",onshow:"半角分号隔开",onfocus:"半角分号隔开"}).InputValidator({min:1,onerror:"必须填写"});
	$("#txtAdminUploadSize").formValidator({validatorGroup:"1",tipid:"tipAdminUploadSize",onshow:"单位为KB",onfocus:"单位为KB"}).RegexValidator({regexp:"num1",datatype:"enum",onerror:"格式不正确"});
	$.formValidator.initConfig({validatorGroup:"2",onError:function(msg){/*alert(msg)*/}});
	$("#txtUserUploadType").formValidator({validatorGroup:"2",tipid:"tipUserUploadType",onshow:"半角分号隔开",onfocus:"半角分号隔开"}).InputValidator({min:1,onerror:"必须填写"});
