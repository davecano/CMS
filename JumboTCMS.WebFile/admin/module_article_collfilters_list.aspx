<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="module_article_collfilters_list.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._article_CollFilters_list" %>
...
function ajaxList(currentpage)
{
	...
	$.ajax({
		...
		url:		"module_article_collfilters_ajax.aspx?oper=ajaxGetList"+ccid,
...
function operater(act){
	...
	$.ajax({
		...
		dataType:	"json",
		data:		"ids="+ids,
		url:		"module_article_collfilters_ajax.aspx?oper=ajaxBatchOper&act="+act+"&time="+(new Date().getTime()) + ccid,
...
function ajaxDel(id){
	$.ajax({
		...
		dataType:	"json",
		data:		"id="+id,
		url:		"module_article_collfilters_ajax.aspx?oper=ajaxDel&time="+(new Date().getTime()) + ccid,
		error:		function(XmlHttpRequest,textStatus, errorThrown){JumboTCMS.Loading.hide();alert(XmlHttpRequest.responseText); },
		success:	function(d){
			switch (d.result)
			{
...
<div class="topnav"> <span class="preload1"></span><span class="preload2"></span>
	<ul id="topnavbar">
		<li class="topmenu"><a href="javascript:void(0);" class="top_link"><span
			...
			<ul class="sub">
				<li><a href="javascript:void(0);" onclick="operater('flag1')">启用</a></li>
				<li><a href="javascript:void(0);" onclick="operater('flag0')">禁用</a></li>
				<li><a href="javascript:void(0);" onclick="operater('pub')">公用</a></li>
				<li><a href="javascript:void(0);" onclick="operater('pri')">私用</a></li>
			</ul>
		</li>
		<li class="topmenu"><a href="javascript:void(0);" class="top_link"><span
            class="down">添加过滤</span></a>
			<ul class="sub">
				<li><a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('module_article_collfilters_edit0.aspx?id=0'+ccid,-1,-1,true)">简单替换</a></li>
				<li><a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('module_article_collfilters_edit1.aspx?id=0'+ccid,-1,-1,true)">高级过滤</a></li>
			</ul>
		</li>
	</ul>
	<script>
...
<tbody>
	...
	<tr>
		...
		<td align="center" class="oper">
			<a href="javascript:void(0);" onclick="JumboTCMS.Popup.show('module_article_collfilters_edit{$T.record.filter_type}.aspx?id={$T.record.id}'+ ccid,-1,-1,true)">修改</a>
