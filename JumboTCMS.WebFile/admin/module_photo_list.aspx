<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="module_photo_list.aspx.cs" Inherits="JumboTCMS.WebFile.Admin._module_photo_list" %>
...
<tbody>
	...
	<tr>
		...
		<td align="left">&nbsp;
			...
			{#else}
			<a href="../controls/photo.aspx?ChannelId={$T.record.channelid}&id={$T.record.id}&preview=1" target="_blank" style="color:{$T.record.tcolor}">{$T.record.title}</a>
			{#/if}
		</td>
