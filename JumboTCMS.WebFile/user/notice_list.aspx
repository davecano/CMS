...
function ajaxList(currentpage)
{
	...
	$.ajax({
		type:		"get",
		dataType:	"json",
		data:		"page="+currentpage+"&pagesize="+pagesize+"&clienttime="+Math.random()+id,
...
<div id="mainarea">
			<h2 class="title"><img src="../statics/app/pm.gif">消息</h2>
			...
			<div id="content">
            <textarea class="template" id="tplList" style="display:none">{#foreach $T.table as record}
<li>
	{$T.record.content}
	&nbsp;
