...
function ajaxDel(id){
	$.ajax({
		...
		dataType:	"json",
		data:		"id="+id,
		url:		"ajax.aspx?oper=ajaxDelFavorite&clienttime="+Math.random(),
...
<div id="wrap">
  <div id="main">
    ...
    <div id="mainarea">
      ...
      <!--右侧列表-->
      <div id="list">
<textarea class="template" id="tplList" style="display:none"><table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<th width="*">标题</th>
	...
	<tr>
		<td align="left">&nbsp;<a href="<%=site.Dir %>content-{$T.record.channelid}-{$T.record.contentid}.aspx" target="_blank">{$T.record.title}</a></td>
