<%@ Page Language="C#" AutoEventWireup="True" Codebehind="maimai_goodslist.aspx.cs" Inherits="JumboTCMS.WebFile.User._maimai_goodslist" %>
...
<div id="wrap">
  <div id="main">
    ...
    <div id="mainarea">
      ...
      <div id="nav_box">
        <ul class="nav_three">
          <li id="tab3"><a href="javascript:void(0);" onclick="aLoad('')">全部</a></li>
          <li id="tab2"><a href="javascript:void(0);" onclick="aLoad('old')">已付款</a></li>
          <li id="tab1"><a href="javascript:void(0);" onclick="aLoad('new')">未付款</a></li>
        </ul>
        <div class="clear"></div>
      </div>
      <!--右侧列表-->
