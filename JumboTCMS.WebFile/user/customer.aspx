<%@ Page Language="C#" AutoEventWireup="True" Codebehind="customer.aspx.cs" Inherits="JumboTCMS.WebFile.User._customer" %>
...
function ajaxTopFriendList()
{
	$.ajax({
		type:		"get",
		dataType:	"json",
		data:		"page=1&pagesize=6&clienttime="+Math.random(),
			...
			<div id="sidebar">
 				<div class="sidebox">
					<h2 class="title">
						...
						我的好友 </h2>
                    <textarea class="template" id="tplRightMenu" style="display:none">{#foreach $T.table as record}
<li>
