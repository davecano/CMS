<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="module_photo_edit.aspx.cs" Inherits="JumboTCMS.WebFile.User._module_photo_edit" %>
...
$(document).ready(function(){
	...
	$("#txtTitle").formValidator({tipid:"tipTitle",onshow:"请输入标题，单引号之类的将自动过滤",onfocus:"至少输入6个字符"}).InputValidator({min:6,onerror:"至少输入6个字符,请确认"})
		...
		type : "get",
		data:		"id=<%=id%>" + ccid,
		url:		"module_photo_ajax.aspx?oper=checkname&clienttime="+Math.random(),
		datatype : "json",
		success : function(d){	
			if(d.result == "1")
				return true;
...
<form id="form1" runat="server" onsubmit="return CheckFormSubmit()">
	<table class="formtable mrg10T">
		...
		<tr>
			<th> 图片地址<span class="tip-r" tip="多个地址之间请用换行分割" /></th>
