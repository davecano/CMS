...
namespace JumboTCMS.WebFile.Modules.Video.Plus
{
    public partial class _play : JumboTCMS.UI.FrontHtml
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                if (videoUrl != "")
                {
                    ...
                    switch (_ext)
                    {
                        ...
                        case "wmv":
                            ...
                            break;
                        case "flv":
                            //_html = "<object type=\"application/x-shockwave-flash\" data=\"" + site.Dir + "statics/flash/videoPlayer/videoPlayer.swf\" width=\"" + vWidth + "\" height=\"" + vHeight + "\" id=\"videoPlayer\"><param name=\"movie\" value=\"" + site.Dir + "statics/flash/videoPlayer/videoPlayer.swf\"/><param name=\"play\" value=\"true\" /><param name=\"loop\" value=\"true\" /><param name=\"allowFullScreen\" value=\"true\" /><param name=\"wmode\" value=\"window\" /><param name=\"FlashVars\" value=\"htmlPage=index.html&settingsFile=" + site.Dir + "statics/flash/videoPlayer/setting" + vAutoPlay + ".xml&flvFile=" + _url + "&previewImage=" + previewImage + "\"/></object>";
           ...
           // if (vFull)
               // Response.Write("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\"><html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"/><title>视频播放器</title><link rel=\"stylesheet\" href=\"" + site.Dir + "statics/flash/videoPlayer/css/css.css\" type=\"text/css\" /><script type=\"text/javascript\" src=\"" + site.Dir + "_libs/jquery.tools.pack.js\"></script></head><body><ul id=\"navigation\"><li id='li_light' class='off'><a style=\"cursor:pointer;\"></a></li><li class='help'><a style=\"cursor:pointer;\"></a></li></ul><div style=\"margin:0px;padding-top:55px;\">" + _html + "</div><script type=\"text/javascript\">$(function() {$('#navigation a').stop().animate({'marginTop':'-33px'},1000);$('#navigation > li').hover(function () {$('a',$(this)).stop().animate({'marginTop':'-2px'},200);},function () {$('a',$(this)).stop().animate({'marginTop':'-33px'},200);});});$('#li_light').click(function() {parent.LightOpenOff();/*if ($(this).hasClass('off')){$(this).removeClass('off');$(this).addClass('open');}else{$(this).removeClass('open');$(this).addClass('off');}*/});$('.help').click(function() {parent.alert('开发中');});</script></body></html>");
           // else
