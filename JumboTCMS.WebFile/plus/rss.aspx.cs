    ...
    public partial class _rss : JumboTCMS.UI.FrontHtml
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ClassId != "0")
                ...
                strCode.Append("        <link>" + Go2Channel(1, teDAL.PageIsHtml(), ChannelId, false) + "</link>\r\n");
            ...
            string sqlStr = "";
            sqlStr = JumboTCMS.Utils.SqlHelper.GetSql0("id,title,Author,AddDate,ChannelId,ClassId,Summary", "jcms_module_" + teDAL.MainChannel.Type, "id", PSize, page, "desc", whereStr);
            doh.Reset();
            doh.SqlCmd = sqlStr;
