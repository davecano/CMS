<%@ Page Language="C#" AutoEventWireup="True" Codebehind="register_step2.aspx.cs" Inherits="JumboTCMS.WebFile.Passport._register_step2" %>
<!doctype html>
<!--STATUS OK-->
<html>
<head>
...
<title>邮件激活 - 新用户注册 <%=site.Name%></title>
...
<div id="wrapper">
  <div id="bd">
    <div id="divRegStep2">
      <div class="psp-title">
        <h2>邮件激活<span class="theme"><a class="default" href="javascript:void(0);" title="蓝色风格" onclick="JumboTCMS.Cookie.set('passport_theme','default');location.reload();"></a><a class="green" href="javascript:void(0);" title="绿色风格" onclick="JumboTCMS.Cookie.set('passport_theme','green');location.reload();"></a></span></h2>
      </div>
