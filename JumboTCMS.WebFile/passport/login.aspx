<%@ Page Language="C#" AutoEventWireup="True" Codebehind="login.aspx.cs" Inherits="JumboTCMS.WebFile.Passport._login" %>
<!doctype html>
<!--STATUS OK-->
<html>
<head>
...
<div id="wrapper" class="login-wrap">
  <div id="bd">
    <div class="psp-title">
      <h2>用户登录<span class="theme"><a class="default" href="javascript:void(0);" title="蓝色风格" onclick="JumboTCMS.Cookie.set('passport_theme','default');location.reload();"></a><a class="green" href="javascript:void(0);" title="绿色风格" onclick="JumboTCMS.Cookie.set('passport_theme','green');location.reload();"></a></span></h2>
    </div>
    <div class="psp-wrap">
      <div class="psp-main cls">
        <div class="psp-container">
          <div class="login-icon">
            ...
            <p class="icon-list oauth-navbar"><a id="oauth_sina" href="#" class="icons icon-sina"></a><a id="oauth_qq" href="#" class="icons icon-qq"></a><a id="oauth_renren" href="#" class="icons icon-renren"></a></p>
          </div>
        </div>
            ...
            <form id="loginform" class="psp-form">
              <ul>
                ...
                <li>
                  ...
                  <span class="v">
                  <input type="password" name="txtUserPass" id="txtUserPass" maxlength="14" class="psp-text" />
                  </span> </li>
                <li>
                  <label class="k" style="width:80px;" for="txtUserCode">验证码：</label>
                  <span class="v">
                  <input class="psp-text" type="text" style="width:80px;ime-mode:disabled;" id="txtUserCode" name="txtUserCode" maxlength="4" size="4" onpaste="return false" /><span id="lblCode"></span>
                  <img class="vcode-img" id="imgCode" onclick="_jcms_GetRefreshCode('imgCode',36);" src="" align="absmiddle" /><a href="javascript:void(0);" id="_vcode_txt" onclick="_jcms_GetRefreshCode('imgCode',36);return false;">换一张</a>  <img id="imgRead" src="../statics/common/maintb.gif" align="absmiddle" style="cursor: pointer" alt="收听验证码" title="收听验证码" onclick="ajaxPlayCodeVoice('player');" /><span id="player"></span></span> </li>
              </ul>
              <div class="btn">
                <input type="button" class="btn-login" onclick="ajaxLogin();" id="btnLogin" value="登录" />
