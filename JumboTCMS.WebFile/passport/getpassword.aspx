<%@ Page Language="C#" AutoEventWireup="True" Codebehind="getpassword.aspx.cs" Inherits="JumboTCMS.WebFile.Passport._getpassword" %>
<!doctype html>
<!--STATUS OK-->
<html>
<head>
...
<div id="wrapper" class="">
  ...
  <div id="bd" class="bd">
    <div class="psp-title">
      <h2>找回密码<span class="theme"><a class="default" href="javascript:void(0);" title="蓝色风格" onclick="JumboTCMS.Cookie.set('passport_theme','default');location.reload();"></a><a class="green" href="javascript:void(0);" title="绿色风格" onclick="JumboTCMS.Cookie.set('passport_theme','green');location.reload();"></a></span></h2>
    </div>
    <div class="psp-wrap">
