<%@ Page Language="C#" AutoEventWireup="True" Codebehind="register.aspx.cs" Inherits="JumboTCMS.WebFile.Passport._register" %>
<!doctype html>
<!--STATUS OK-->
<html>
<head>
...
<div id="wrapper">
  <div id="bd">
    <div id="divRegStep1">
      <div class="psp-title">
        <h2>用户注册<span class="theme"><a class="default" href="javascript:void(0);" title="蓝色风格" onclick="JumboTCMS.Cookie.set('passport_theme','default');location.reload();"></a><a class="green" href="javascript:void(0);" title="绿色风格" onclick="JumboTCMS.Cookie.set('passport_theme','green');location.reload();"></a></span></h2>
      </div>
        ...
        <div class="psp-main cls">
            ...
            <form id="registerForm" action="ajax.aspx?oper=ajaxRegister" method="post" class="psp-form">
              <ul>
                <li>
                  ...
                  <span class="v">
                  <input autocomplete="off" class="psp-text" style="width:180px;ime-mode:disabled;" type="text" name="txtEmail" id="txtEmail" maxlength="60" value="" onpaste="return false"  />
                ...
                <li>
                  ...
                  <span class="v">
                  <input class="psp-text" style="width:180px" type="password" maxlength="14" name="txtPass1" id="txtPass1" value="" onpaste="return false"  />
                  </span><em id="tipPass1"></em> </li>
                <li>
                  <label class="k" for="txtPass2">确认密码：</label>
                  <span class="v">
                  <input class="psp-text" style="width:180px" type="password" maxlength="14" name="txtPass2" id="txtPass2" value="" onpaste="return false"  />
                ...
                <li>
                  ...
                  <span class="v">
                  <input class="psp-text" style="width:80px;ime-mode:disabled;" type="text" id="txtCode" name="txtCode" maxlength="4" size="4" onpaste="return false" />
                  <img class="vcode-img" id="imgCode" onclick="_jcms_GetRefreshCode('imgCode',36);" src="" align="absmiddle" /><a href="javascript:void(0);" id="_vcode_txt" onclick="_jcms_GetRefreshCode('imgCode',36);return false;">换一张</a> <img id="imgRead" src="../statics/common/maintb.gif" align="absmiddle" style="cursor: pointer" alt="收听验证码" title="收听验证码" onclick="ajaxPlayCodeVoice('player');" /><span id="player"></span><em id="tipCode"></em></span> </li>
                <li style="display:none;">
                ...
                <li>
                  <input type="submit" value="立即注册" onclick="SetMD5(true);" id="btn_reg_submit" class="btn-reg" />
                </li>
                <li></li>
              </ul>
            </form>
          ...
          <div class="psp-sidebar">
            ...
            <div class="other-signin oauth-navbar">
              <p>使用合作网站帐号登录</p>
              <div class="other-list"> <a id="oauth_sina" href="#" class="sina">新浪微博</a> <a id="oauth_qq" href="#" class="qq">QQ</a> <a id="oauth_renren" href="#" class="renren">人人网</a> </div>
            </div>
  ...
  <div class="copyright">
    <div class="copyright-inner">
      ...
      <div class="copyright-info">
        <p> <span>&copy; 2007-2016</span> <span><%=site.Name%>版权所有</span> <a href="http://www.miibeian.gov.cn" target="_blank"><%=site.ICP%></a> </p>
...
$(document).ready(function(){
	if (site.AllowReg){_jcms_SetOAuthBar();}
...
function SetMD5(n){
	if(n){
		pass1 = $('#txtPass1').val();
		pass2 = $('#txtPass2').val();
		$('#txtPass1').val(JumboTCMS.MD5(pass1));
		$('#txtPass2').val(JumboTCMS.MD5(pass2));
	}else{
		$('#txtPass1').val(pass1);
		$('#txtPass2').val(pass2);
	}
