...
document.write('    <tr>');
document.write('      <td width="110" ondbclick="if($i(\'qqtab\').style.display==\'none\'){$i(\'qqtab\').style.display=\'\'} else {$i(\'qqtab\').style.display=\'none\'}"><img src="'+site.Dir+'extends/qqonline/images/qqskin/'+QQOnlineInfo.siteskin+'/top.gif" border="0"></td>');
document.write('    </tr>');
...
document.write('    </tr>');
document.write('    <tr>');
document.write('      <td width="110" ondbclick="if($i(\'qqstab\').style.display==\'none\'){$i(\'qqstab\').style.display=\'\'} else {$i(\'qqstab\').style.display=\'none\'}"><img src="'+site.Dir+'extends/qqonline/images/qqskin/'+QQOnlineInfo.siteskin+'/bottom.gif" border="0"></td>');
document.write('    </tr>');
document.write('</table>');
document.write('</div>');
