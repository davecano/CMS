...
CREATE TABLE [jcms_normal_theme] (
	[Id] AutoIncrement primary key ,
	[Title] varchar(100) NOT NULL DEFAULT "",
	[PId] int NOT NULL DEFAULT "0",
...
CREATE TABLE [jcms_normal_themeproject] (
	[Id] AutoIncrement primary key ,
	[Title] varchar(100) NOT NULL DEFAULT "",
	[Info] varchar(200) NOT NULL DEFAULT "",
...
CREATE TABLE [jcms_normal_user] (
	...
	[AdminPass] varchar(64) NULL DEFAULT "",
	[AdminSetting] text NOT NULL DEFAULT "",
	...
	[Token_QQ] varchar(32) NULL DEFAULT "",
	[Token_Weixin] varchar(32) NULL DEFAULT "",
	[Token_Baidu] varchar(32) NULL DEFAULT "",
	[Token_Taobao] varchar(32) NULL DEFAULT "",
...
CREATE TABLE [jcms_email_smtpserver] (
	[Id] AutoIncrement primary key ,
...
CREATE TABLE [jcms_email_usergroup] (
	[Id] AutoIncrement primary key ,
	[GroupName] varchar(50) NOT NULL DEFAULT "",
...
CREATE TABLE [jcms_email_sendlogs] (
	[Id] AutoIncrement primary key ,
	[AdminId] int NOT NULL DEFAULT "0",
...
CREATE TABLE [jcms_normal_themeinclude] (
	[Id] AutoIncrement primary key ,
	[Title] varchar(100) NOT NULL DEFAULT "",
	[Info] varchar(200) NOT NULL DEFAULT "",
	[PId] int NOT NULL DEFAULT "0",
...
CREATE TABLE [jcms_normal_user_recharge] (
	[Id] AutoIncrement primary key ,
